 ...
 * @param {number} left Margin form the left edge.
 ...
 Height and Width for the dimension block
 Top, Right Bottom Left for the paddings
...
// set up dimensions for the plotting different graphs	.
...
//number of targets,  thus number of verticle lines the graph is to be divided in
...
// d3.scale.linear --> to scale the domain values into the range of values defined.
